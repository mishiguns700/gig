...
# группа с машинкой-игроком
all_sprites = pygame.sprite.Group()
# группа с машинками в левой части экрана
all_sprites2 = pygame.sprite.Group()
# группа с машинками в правой части экрана
all_sprites2_r = pygame.sprite.Group()
# группа с картинкой конца игры
all_sprites_gameover = pygame.sprite.Group()
# спрайт машинки-игрока
sprite = pygame.sprite.Sprite()
# спрайт машинок в левой части экрана
Cars = pygame.sprite.Sprite()
# спрайт машинок в правой части экрана
Cars_r = pygame.sprite.Sprite()
# спрайт с картинкой конца игры
...
# определение в левой части полосы на которой будет ехать машинка
r = random.choice([0, 1])
# определение в правой части полосы на которой будет ехать машинка
...
if __name__ == '__main__':
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.USEREVENT and over is False:
                counter += 1
        ...
        if Cars_r.rect.y != 1024 and over is False:
            Cars_r.rect.y += 2
        ...
        if Cars.rect.y != 1024 and over is False:
            Cars.rect.y += 3
        ...
        if sprite.rect.x == 850 and over is False:
            right = False

        if sprite.rect.x == 70 and over is False:
            left = False

        if right is True and over is False:
            sprite.rect.x += 3
            all_sprites.update()

        if left is True and over is False:
            sprite.rect.x -= 3
            all_sprites.update()
